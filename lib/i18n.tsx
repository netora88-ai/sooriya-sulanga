...
const translations: Dict = {
  ...
  'name.samadhi-prarthana': { en: 'Samadhi Prarthana', si: 'සමධි ප්‍රාර්ථනා' },
  'name.terry-jayasinghe': { en: 'Terry Jayasinghe', si: 'ටෙරී ජයසිංහ' },
  'name.lahiru-balasooriya': { en: 'Lahiru Balasooriya', si: 'ලහිරු බාලසූරිය' },
  'name.muthu-tharanga': { en: 'Muthu Tharanga', si: 'මුතු තරංග' },
  'name.sandun-bandara': { en: 'Sandun Bandara', si: 'සදුන් බණ්ඩාර' },
  'name.priyankara-rathnayake': { en: 'Priyankara Rathnayake', si: 'ප්‍රියංකර රත්නායක' },
  'name.athula-jayasinghe': { en: 'Athula Jayasinghe', si: 'අතුල ජයසිංහ' },
  'name.chinthaka-vaas': { en: 'Chinthaka Vaas', si: 'චින්තක වාස්' },
